...
function table_power() {
	...
	str += "</table>";
	document.getElementById("test_lab04").innerHTML = str;
	return false;
}
...
function test_3() {
	...
	str += '<div class="input-group mb-3"><input id="test_textfield" type="text" class="form-control" placeholder="0,-1,2,5,0"><div class="input-group-append"><button class="btn btn-primary" type="button" onclick="test_3_out()">Contar</button></div></div><div id="test_lab04_result"></div>';
	document.getElementById("test_lab04").innerHTML = str;
}
...
function test_3_out() {
	...
	document.getElementById("test_lab04_result").innerHTML = str;
...
function test_4() {
	...
	str += '<div class="input-group mb-3"><input id="test_textfield" type="text" class="form-control" placeholder="0,-1,2,5,0"><div class="input-group-append"><button class="btn btn-primary" type="button" onclick="test_4_out()">Promediar</button></div></div><div id="test_lab04_result"></div>';
	document.getElementById("test_lab04").innerHTML = str;
}
...
function test_5() {
	...
	str += '<div class="input-group mb-3"><input id="test_textfield" type="text" class="form-control" placeholder="12345"><div class="input-group-append"><button class="btn btn-primary" type="button" onclick="test_5_out()">Invertir</button></div></div><div id="test_lab04_result"></div>';
	document.getElementById("test_lab04").innerHTML = str;
}
...
function test_5_out() {
	...
	document.getElementById("test_lab04result").innerHTML = str;
...
function test_6() {
	...
	str += '<div class="input-group mb-3"><input id="test_textfield" type="text" class="form-control" placeholder="radio"><div class="input-group-append"><button class="btn btn-primary" type="button" onclick="test_6_out()">Calcular</button></div></div><div id="test_lab04_result"></div>';
	document.getElementById("test_lab04").innerHTML = str;
}
